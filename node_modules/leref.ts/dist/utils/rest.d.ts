...
export declare type Tracks = TrackData[];
...
export declare type RoutePlanners = BalancingRoutePlanner | RotatingRoutePlanner | NanoRoutePlanner | RotatingNanoRoutePlanner;
